...
import {
  ...
  Music, Scissors, Trash2, Copy, Clock4
} from 'lucide-react'
...
function CanvasControls({
  ...
  const renderAudioControls = () => {
    if (!selectedAudioBlock || selectedLayer) return null
    ...
    return (
      <>
        ...
        {!isMobileBottom && (
          <div className={`flex items-center gap-1.5 flex-shrink-0 pr-2 mr-1 border-r ${isLight ? 'border-black/10' : 'border-white/10'
            }`}>
            <Music className="h-3.5 w-3.5 opacity-60" strokeWidth={1.5} />
            <span className={`text-[11px] font-semibold max-w-[100px] truncate ${isLight ? 'text-gray-600' : 'text-white/70'
        ...
        <div className="relative flex-shrink-0" ref={audioVolumeBtnRef}>
          <button
            ...
            className={`h-8 px-2 rounded-[8px] transition-all flex items-center justify-center touch-manipulation border ${showAudioVolume
              ? theme === 'light'
                ? 'bg-black/10 border-black/10 text-gray-900'
            ...
            <ControlPopover open={showAudioVolume} anchorRef={audioVolumeBtnRef}>
              ...
              >
                ...
                <button
                  ...
                  className={`p-1 rounded transition-colors ${theme === 'light' ? 'hover:bg-black/5 text-gray-700' : 'hover:bg-white/10 text-white'
                    }`}
        ...
        <button
          ...
          className={`h-8 px-2 rounded-[8px] transition-all flex items-center justify-center touch-manipulation flex-shrink-0 border ${theme === 'light'
            ? 'text-gray-700 hover:bg-gray-100 border-transparent hover:border-gray-200'
            : 'text-white hover:bg-white/10 border-transparent hover:border-white/10'
            }`}
        ...
        <div className="flex items-center gap-1 px-2 flex-1 rounded-l-[11px]">
          <div className={`flex items-center gap-0.5 pr-2 mr-1 border-r border-black/10 dark:border-white/10`}>
            <button
              onClick={onUndo}
              disabled={!canUndo}
              className={`h-8 w-8 rounded-[8px] transition-all flex items-center justify-center touch-manipulation disabled:opacity-30 disabled:pointer-events-none ${theme === 'light'
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {selectedAudioBlock ? renderAudioControls() : (
                    <>
                      ...
                      {selectedCanvas && currentScene && (
                        <div className="flex items-center gap-2 flex-shrink-0 mr-2">
                          ...
                          {/* Divider */}
                          <div className={`w-px h-5 mx-1 ${theme === 'light' ? 'bg-black/10' : 'bg-white/10'}`} />
                          ...
                          <button
                            ...
                            className={`h-8 px-2 rounded-[8px] transition-all flex items-center justify-center gap-1.5 touch-manipulation flex-shrink-0 border ${scenes.length <= 1
                          ...
                          <button
                            ...
                            className={`h-8 px-2 rounded-[8px] transition-all flex items-center justify-center gap-1.5 touch-manipulation flex-shrink-0 border ${theme === 'light'
                              ? 'text-gray-700 hover:bg-gray-100 border-transparent hover:border-gray-200'
                              : 'text-white hover:bg-white/10 border-transparent hover:border-white/10'
                              }`}
                          ...
                          {/* Duration display */}
                          <span className={`flex items-center gap-1.5 text-xs font-semibold px-2 whitespace-nowrap ${theme === 'light' ? 'text-gray-500' : 'text-zinc-400'}`}>
                            <Clock4 className="h-4 w-4" strokeWidth={2} />  {currentScene.duration ? currentScene.duration.toFixed(1) : '0'}s
                          </span>
                            ...
                            trigger={
                              <button
                                className={`h-8 px-2 rounded-[8px] transition-all flex items-center justify-center min-w-[44px] border ${selectedLayer.data?.enableFlow
                                  ? (theme === 'light' ? 'bg-black/10 border-black/10 text-gray-900' : 'bg-white/20 border-white/20 text-white')
                                  : (theme === 'light'
                                    ? 'text-gray-700 hover:bg-gray-100 border-transparent hover:border-gray-200'
                                    : 'text-white hover:bg-white/10 border-transparent hover:border-white/10')
                                  }`}
                        ...
                        <div className="relative flex-shrink-0">
                          <button
                            ...
                            className={`h-8 px-2 rounded-[8px] transition-all flex items-center gap-1.5 touch-manipulation whitespace-nowrap border ${theme === 'light'
                              ? (showCornerRadiusSlider ? 'bg-black/10 border-black/10 text-gray-900' : 'text-gray-700 hover:bg-gray-100 border-transparent hover:border-gray-200')
                      ...
                      {selectedLayer && selectedLayer.type !== LAYER_TYPES.BACKGROUND && (
                        <div className="relative flex-shrink-0">
                          <button
                            ...
                            className={`h-8 px-2 rounded-[8px] transition-all flex items-center gap-1.5 touch-manipulation whitespace-nowrap border ${theme === 'light'
                              ? (showOpacitySlider ? 'bg-black/10 border-black/10 text-gray-900' : 'text-gray-700 hover:bg-gray-100 border-transparent hover:border-gray-200')
                      ...
                      {selectedLayer && selectedLayer.type !== LAYER_TYPES.BACKGROUND && (
                        <div className="relative flex-shrink-0">
                          <button
                            ...
                            className={`h-8 px-2 rounded-[8px] transition-all flex items-center gap-1.5 touch-manipulation whitespace-nowrap border ${theme === 'light'
                              ? (showBlurSlider ? 'bg-black/10 border-black/10 text-gray-900' : 'text-gray-700 hover:bg-gray-100 border-transparent hover:border-gray-200')
                      ...
                      {selectedLayer && selectedLayer.type !== LAYER_TYPES.BACKGROUND && (
                        <div className="relative flex-shrink-0">
                          <button
                            ...
                            className={`h-8 px-2 rounded-[8px] transition-all flex items-center gap-1.5 touch-manipulation whitespace-nowrap border ${theme === 'light'
                              ? (showTiltPanel ? 'bg-black/10 border-black/10 text-gray-900' : 'text-gray-700 hover:bg-gray-100 border-transparent hover:border-gray-200')
                    ...
                    {selectedCanvas && currentScene && (
                      <>
                        ...
                        <button
                          ...
                          title="Cut Scene"
                        >
                          <Scissors className="h-4 w-4 flex-shrink-0 opacity-70" strokeWidth={2} />
                        </button>
                ...
                {DEFAULT_COLORS.map((color, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-7 h-7 rounded-full shrink-0 cursor-pointer transition-all active:scale-95 ${isSelected ? 'ring-2 ring-purple-500 scale-105 shadow-md' : 'hover:ring-2 hover:ring-zinc-500'
                        }`}
                  ...
                  {DEFAULT_COLORS.map((color, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-8 h-8 rounded-full cursor-pointer transition-all active:scale-95 ${isSelected ? 'ring-2 ring-purple-500 scale-105 shadow-md' : 'hover:ring-2 hover:ring-zinc-500'
                          }`}
                        style={{ backgroundColor: color }}
                        title={color}
                      />
            ...
            {fonts.map((font) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg shrink-0 text-xs font-medium transition-all active:scale-95 border ${isSelected
        ...
        >
          <div className="flex items-center gap-1.5 shrink-0 select-none">
            ...
            <input
              ...
              className={`font-size-input w-12 h-7 px-1 rounded-lg text-xs font-mono font-bold text-center border focus:outline-none focus:border-purple-500/50 ${theme === 'light'
            ...
            {[8, 10, 12, 14, 16, 18, 20, 24, 28, 32, 36, 48, 64, 72, 96, 120].map((size) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1 rounded-lg shrink-0 text-xs font-mono font-bold transition-all active:scale-95 border ${isSelected
                    ? 'bg-purple-600/20 border-purple-500/50 text-purple-400 shadow-sm'
                    : (theme === 'light' ? 'bg-gray-100 text-gray-700 border-gray-200 hover:bg-gray-200' : 'bg-white/5 text-white border-transparent hover:bg-white/10')
                    }`}
                >
        ...
        >
          ...
          <div className="flex items-center gap-3 overflow-x-auto scrollbar-none grow px-2 py-1 justify-center">
            ...
            <button
              ...
              className={`p-2 rounded-lg shrink-0 transition-all active:scale-95 border flex items-center gap-1.5 text-xs font-semibold ${selectedLayer.data?.textAlign === 'left' || !selectedLayer.data?.textAlign
            ...
            <button
              ...
              className={`p-2 rounded-lg shrink-0 transition-all active:scale-95 border flex items-center gap-1.5 text-xs font-semibold ${selectedLayer.data?.textAlign === 'center'
                ? 'bg-purple-600/20 border-purple-500/50 text-purple-400'
                : (theme === 'light' ? 'bg-gray-100 text-gray-700 border-gray-200' : 'bg-white/5 text-white border-transparent')
                }`}
            >
            ...
            <button
              ...
              className={`p-2 rounded-lg shrink-0 transition-all active:scale-95 border flex items-center gap-1.5 text-xs font-semibold ${selectedLayer.data?.textAlign === 'right'
                ? 'bg-purple-600/20 border-purple-500/50 text-purple-400'
                : (theme === 'light' ? 'bg-gray-100 text-gray-700 border-gray-200' : 'bg-white/5 text-white border-transparent')
                }`}
            >
            ...
            <button
              ...
              className={`p-2 rounded-lg shrink-0 transition-all active:scale-95 border flex items-center gap-1.5 text-xs font-semibold ${selectedLayer.data?.enableFlow
