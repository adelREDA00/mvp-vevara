      ...
      >
        ...
        <div className="flex items-center gap-3 md:gap-4 flex-shrink-0">
          ...
          <button
            ...
            className="flex h-9 w-9 rounded-[10px] hover:bg-white/10 active:bg-white/20 items-center justify-center transition-all text-white/80 hover:text-white"
            title="Home"
          >
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              onClick={onSave}
              disabled={isSaving}
              className="text-white hover:bg-white/10 active:bg-white/20 h-9 px-3 rounded-[10px] transition-all flex items-center gap-2 touch-manipulation whitespace-nowrap text-sm font-semibold disabled:opacity-50"
            ...
            <DropdownMenu
              trigger={
                <button className="text-white/80 hover:text-white hover:bg-white/10 active:bg-white/20 h-9 px-3 rounded-[10px] transition-all flex items-center gap-1.5 touch-manipulation whitespace-nowrap text-sm font-semibold">
        ...
        {/* Center Section - Project Name or Open Account Button (centered relative to workspace) */}
        <div
        ...
        <div className="flex items-center gap-1.5 md:gap-2.5 flex-shrink-0">
          ...
          <div className="md:hidden">
            <DropdownMenu
              trigger={
                <button className="text-white/80 hover:text-white hover:bg-white/10 active:bg-white/20 h-8 w-8 rounded-lg transition-all flex items-center justify-center touch-manipulation">
          ...
          {!hideExport && (
            <div className="hidden md:block">
              <DropdownMenu
                trigger={
                  <button
                    className="text-white hover:bg-white/10 active:bg-white/20 font-semibold gap-1.5 h-9 px-3 text-sm rounded-[10px] transition-all flex items-center touch-manipulation whitespace-nowrap"
                    title="Export"
                  >
          ...
          <button
            ...
            className="lg:hidden text-white hover:bg-white/10 active:bg-white/20 h-8 w-8 rounded-lg transition-all flex items-center justify-center touch-manipulation"
            title="Open Sidebar"
          >
