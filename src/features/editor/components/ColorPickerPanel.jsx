    ...
    <>
      ...
      >
        {onClose && (
          <button
            onClick={onClose}
            className={`absolute top-3 right-3 z-50 transition-colors p-1 rounded-md ${isLight ? 'text-gray-400 hover:text-gray-900 hover:bg-gray-100' : 'text-zinc-400 hover:text-white hover:bg-zinc-800'} hidden lg:block`}
          >
