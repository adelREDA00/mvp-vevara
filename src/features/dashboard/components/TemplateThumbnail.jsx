...
const TemplateThumbnail = memo(({ project, buttonText = "Edit Template" }) => {
    ...
    return (
        <div
            ...
            className="aspect-video bg-[var(--dashboard-card-bg)] border border-[var(--dashboard-border)] rounded-[12px] md:rounded-[16px] overflow-hidden relative mb-3 group-hover:border-slate-500/40 transition-all duration-300 shadow-none"
        >
