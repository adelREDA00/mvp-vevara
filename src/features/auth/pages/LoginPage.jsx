                ...
                <div className="p-8 md:p-10 relative">
                    <div className="w-full">
                                ...
                                <div className="animate-in fade-in slide-in-from-top-4 duration-500">
                                    <div className="relative my-6">
                                        ...
                                        <div className="relative flex justify-center text-[10px] font-bold uppercase tracking-[0.25em]">
                                            <span className="bg-[var(--dashboard-card-bg)] px-4 text-[var(--dashboard-text-muted)]/60">Email Sign In</span>
                                        </div>
                                    </div>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <div className="relative group/input">
                                                <User size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-[var(--dashboard-text-muted)]/60 group-focus-within/input:text-[var(--dashboard-accent)] transition-colors" />
                                                <input
                                                    type="email"
                                                    value={email}
                                                    onChange={(e) => {
                        ...
                        <p className="text-center mt-8 text-[var(--dashboard-text-muted)] text-[14px]">
                            New here?{' '}
                            <Link to="/register" className="text-[var(--dashboard-accent)] hover:text-[var(--dashboard-accent-hover)] font-bold transition-all ml-1 underline underline-offset-4">
                                Create an account
                            </Link>
                        </p>
                    </div>
