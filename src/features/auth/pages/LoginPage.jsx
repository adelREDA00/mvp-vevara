...
const LoginPage = () => {
    ...
    return (
        <div className="min-h-[100dvh] bg-[#0f1015] flex flex-col items-center justify-start md:justify-center p-0 md:p-12 font-normal selection:bg-[#6940c9]/30 overflow-y-auto overflow-x-hidden relative">
            ...
            <div className="w-full max-w-4xl bg-transparent md:bg-white/[0.01] md:backdrop-blur-3xl rounded-none md:rounded-[32px] relative z-10 flex flex-col md:flex-row md:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] my-auto overflow-hidden shrink-0 border border-white/5">
                ...
                <div className="md:w-5/12 p-6 md:p-12 flex flex-col justify-center md:bg-gradient-to-br md:from-white/[0.03] md:to-transparent relative shrink-0">
                    ...
                    <div className="flex flex-row md:flex-col items-center md:items-start gap-4 md:gap-0">
                        ...
                        <h1 className="text-xl md:text-4xl font-semibold text-white tracking-tight leading-tight">
                            motion that  <span className="text-[#6940c9] italic">stays simple.</span>
                        </h1>
                        {/* <p className="hidden md:block text-white/40 mt-4 text-[14px] leading-relaxed max-w-[280px]">
                    ...
                    {/* <div className="mt-12 hidden md:block">
                        <div className="flex items-center gap-3">
                            ...
                            <p className="text-[12px] text-white/30 font-semibold tracking-wide uppercase">Join 200+ creators</p>
                        </div>
                    </div> */}
                </div>
                ...
                <div className="md:w-7/12 p-6 md:p-12 relative">
                    <div className="max-w-[340px] mx-auto md:mx-0">
                        <div className="mb-8">
                            ...
                            <p className="text-white/30 mt-1.5 text-[14px]">Continue your creative journey</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <div className="relative group/input">
                                    <User size={18} strokeWidth={2} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/10 group-focus-within/input:text-[#6940c9] transition-colors" />
                                    <input
                                        type="email"
                                        value={email}
                                        onChange={(e) => {
                            ...
                            <button
                                ...
                                className="w-full h-12 bg-[#6940c9] hover:bg-[#7b52da] disabled:bg-[#6940c9]/50 disabled:cursor-not-allowed text-white font-semibold rounded-[12px] shadow-sm transition-all duration-200 transform active:scale-[0.98] mt-4 flex items-center justify-center gap-2 text-[15px]"
                            >
                                {status === 'loading' ? (
                                    ...
                                    <>
                                        <span>Continue</span>
                                        <ExternalLink size={14} strokeWidth={2.5} className="opacity-50" />
                                    </>
                                )}
                            </button>
                        </form>
                        ...
                        >
                            <svg size={18} className="w-4 h-4" viewBox="0 0 24 24">
                        ...
                        <p className="text-center mt-10 text-white/30 text-[14px]">
                            New here? {' '}
                            <Link to="/register" className="text-white hover:text-[#6940c9] font-semibold transition-all ml-1 underline underline-offset-4 decoration-white/10 hover:decoration-[#6940c9]/30">
                                create an account
                            </Link>
                        </p>
                    </div>
