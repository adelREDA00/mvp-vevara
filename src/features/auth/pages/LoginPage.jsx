                ...
                <div className="p-8 md:p-12 relative">
                    <div className="w-full">
                        <div className="mb-10 text-center">
                            ...
                            <p className="text-white/30 mt-2 text-[15px]">Sign in to your account</p>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <svg size={20} className="w-5 h-5" viewBox="0 0 24 24">
                                ...
                                <div className="animate-in fade-in slide-in-from-top-4 duration-500">
                                    <div className="relative my-8">
                                        ...
                                        <div className="relative flex justify-center text-[11px] font-bold uppercase tracking-[0.2em]">
                                            <span className="bg-[#090a0d] md:bg-[#121318] px-4 text-white/20">Email Sign In</span>
                                        </div>
                                    </div>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-5">
                                        ...
                                        <button
                                            ...
                                            className="w-full h-12 bg-[#6940c9] hover:bg-[#7b52da] disabled:bg-[#6940c9]/50 disabled:cursor-not-allowed text-white font-semibold rounded-[12px] shadow-sm transition-all duration-200 transform active:scale-[0.98] mt-2 flex items-center justify-center gap-2 text-[15px]"
                                        >
                                            {status === 'loading' ? (
